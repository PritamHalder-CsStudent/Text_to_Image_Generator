      ...
      <div>
        {user ? 
          <div className='flex items-center gap-2 sm:gap-3'>
            <button onClick={()=>navigate('/buy-credit')} className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 
        ...
        :
          <div className='flex items-center gap-2 sm:gap-5'>
            ...
            <button className='px-4 py-1.5 bg-gray-800 text-white rounded-2xl sm:px-7 hover:bg-gray-900 
            transition cursor-pointer' onClick={()=>setShowLogin(true)}>Login
            </button>
          </div>
        }
